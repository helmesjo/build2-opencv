# libopencv-calib - Camera calibration and 3D reconstruction
...
provides camera calibration: single and stereo camera calibration, hand-eye
calibration, and the fisheye camera model. The backward-compatible
`opencv2/calib3d.hpp` header (which additionally pulls in the `stereo` module)
...
reconstruction, hand-eye calibration, and the fisheye camera model.
