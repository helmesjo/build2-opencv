# libopencv-stitching - Images stitching
...
provides image stitching: panorama composition from feature matching, motion
estimation, exposure compensation, seam finding, and blending.
...
`Stitcher` pipeline and its lower-level `detail` building blocks.
