# libopencv-highgui - High-level GUI
...
provides a high-level GUI: window display and UI controls (`cv::imshow`,
...
standard, fully-supported headless OpenCV configuration: every windowing
function still exists in the public API but throws a `cv::Exception` at call
