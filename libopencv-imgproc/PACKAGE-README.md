# libopencv-imgproc - Image processing
...
provides image processing: filtering, geometric transformations, color space
conversions, structural analysis, histograms, and drawing/text rendering.
