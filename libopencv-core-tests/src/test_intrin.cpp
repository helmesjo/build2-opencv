...
// to a 256-/512-bit width, which only the x86 AVX2/AVX512 backends can
// satisfy (NEON is fixed at 128 bits); restrict them to x86 accordingly.
...
// See the x86-only guard around test_intrin256.simd.hpp's inclusion above:
// none of this namespace's content is meaningful without it.
#if defined(__i386__) || defined(__x86_64__) || defined(_M_IX86) || defined(_M_X64)
...
// See the x86-only guard around test_intrin512.simd.hpp's inclusion above:
// none of this namespace's content is meaningful without it.
#if defined(__i386__) || defined(__x86_64__) || defined(_M_IX86) || defined(_M_X64)
